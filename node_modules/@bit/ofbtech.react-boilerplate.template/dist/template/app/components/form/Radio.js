...
var RadioConfig = _tcombForm["default"].struct({
...
function getRadio(obj, text, key) {
  ...
  return _react["default"].createElement("div", {
    key: key,
    className: "radioItem ".concat((0, _classnames["default"])(radioGroupClasses))
  }, _react["default"].createElement("label", {
    className: "radioLabel",
    htmlFor: attrs.id
  }, _react["default"].createElement("input", attrs), _react["default"].createElement("span", null, text)));
}
...
function create() {
  ...
  radio.renderRadios = overrides.renderRadios || function renderRadios(obj) {
    var locals = obj;
    ...
    return locals.options.map(function (option, i) {
      var radioView = locals.attrs.horizontalView;
  ...
  radio.renderLabel = overrides.renderLabel || function renderLabel(locals) {
    if (locals.attrs.horizontalView) {
      return _react["default"].createElement("div", null, (0, _getLabel["default"])({
        label: locals.label,
